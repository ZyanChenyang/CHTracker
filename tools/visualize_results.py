...
def make_parser():
    ...
    parser.add_argument('--img_dir', default="datasets/DanceTrack/val")
    parser.add_argument('--exp_name', default="track_results", type=str)
    parser.add_argument('--vis', default="track", type=str, help="det/track/gt")
    parser.add_argument("--dataset", default="dancetrack_val", type=str)
    parser.add_argument("--res", default="/home/ycy/code/Hierarchical-SORT-ECC-ReID/YOLOX_outputs/yolox_dancetrack_val_hierarchical_sort/yolox_dancetrack_val_hierarchical_sort_val_EGWeightHigh4.0_EGWeightLow4.4_WithLongTermReIDCorrectionTrue_LongTermReIDCorrectionThresh1.0_LongTermReIDCorrectionThreshLow1.0_IoUThresh0.15_ScoreDifInterval1.0_SecScoreDifInterval1.0", type=str)
