...
class KalmanFilterNew_score_new(object):
    ...
    **Example**
    ...
    def update(self, z, confidence=None, track_confidence=None, R=None, H=None):
        """
        ...
        if confidence is not None and confidence * track_confidence > 0:
            R = R * (0.95 + 0.05/0.55 * (confidence * track_confidence)) 
